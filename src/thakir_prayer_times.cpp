      ...
      athan(nullptr)
{
    ...
    QIcon icon(":/icons/thakir_prayer_times.png");
...
void thakir_prayer_times_HAF::thakir_prayer_times_Calculer()
{
    readDataFromUI();
...
void thakir_prayer_times_HAF::thakir_prayer_times_Activer_toolBox1()
{
    toolBox->setCurrentIndex(0);
    radioButton_sitting_monde->setChecked(false);
}

void thakir_prayer_times_HAF::thakir_prayer_times_Activer_toolBox2()
{
    toolBox->setCurrentIndex(1);
    radioButton_sitting_Algerie->setChecked(false);
}
void thakir_prayer_times_HAF::radioButton_sitting_user_setNotChecked()
{
    if (radioButton_sitting_HAF->isChecked())
    {
...
void thakir_prayer_times_HAF::radioButton_sitting_HAF_setNotChecked()
{
    if (radioButton_sitting_user->isChecked())
    {
...
void thakir_prayer_times_HAF::readSettings()
{
...
void thakir_prayer_times_HAF::writeSettings()
{
...
void thakir_prayer_times_HAF::updateSettings()
{
...
void thakir_prayer_times_HAF::closeEvent(QCloseEvent *event)
{
    writeSettings();
...
void thakir_prayer_times_HAF::readDataFromUI()
{
...
void thakir_prayer_times_HAF::setVisible(bool visible)
{
...
void thakir_prayer_times_HAF::iconActivated(QSystemTrayIcon::ActivationReason reason)
{
    switch (reason) {
...
//------------- HAF 19-6-2009 ------
void thakir_prayer_times_HAF::COMMUN_Update(int i)
{
...
//void thakir_prayer_times_HAF::about()
//{
...
void thakir_prayer_times_HAF::aboutbis()
{
    //athan->play();
    //releaseKb();
    actTexte1->setEnabled(false);
